...
export default function SuppliersForm() {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        setError(
          isRTL ? "خطأ في تحميل بيانات الخدمة" : "Error loading service data"
        );
      } finally {
  ...
  const validateStep = async (
    s: Step
  ): Promise<{ message: string; field?: keyof FormValues } | null> => {
    if (s === 1) {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center ">
        <div className="max-w-md w-full  rounded-lg shadow-lg p-8 text-center">
          ...
          <p className=" mb-6" dir={isRTL ? "rtl" : "ltr"}>
            {isRTL ? 'شكراً لثقتك — الدلتا للاستيراد والتصدير' : 'Thanks for your trust — Eldelta Import & Export'}
          </p>
          <button
            onClick={() => router.push('/services')}
            className="bg-purple-600 text-white px-6 py-2 rounded-lg hover:bg-purple-700 transition-colors"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  className={`w-full px-3 py-2 border outline-none rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent ${
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <label className="flex gap-3 items-center p-4 border border-gray-300 rounded-lg cursor-pointer ">
                  <input
                    type="radio"
                    value="supplier"
                    {...register("searchType", {
                    ...
                    className="mr-3 h-4 w-4 outline-none text-purple-600 focus:ring-purple-500 border-gray-300"
                  />
                  <div>
                    <div className="font-medium " dir={isRTL ? "rtl" : "ltr"}>
                      {isRTL ? "مورد" : "Supplier"}
                    </div>
                    <div
                    ...
                    >
                      {isRTL
                        ? "البحث عن موردين للمنتجات"
                        : "Looking for product suppliers"}
                    </div>
                  </div>
                </label>
                ...
                <label className="flex gap-3 items-center p-4 border border-gray-300 rounded-lg cursor-pointer ">
                  ...
                  <div>
                    ...
                    >
                      {isRTL
                        ? "البحث عن مستوردين للمنتجات"
                        : "Looking for product importers"}
                    </div>
                  </div>
                </label>
              </div>
            ...
            <div>
              ...
              >
                {isRTL
                  ? "نوع المنتج أو المجال المطلوب *"
                  : "Required product type or field *"}
              </label>
              <select
              ...
              >
                <option value="" className="text-gray-700">
                  {isRTL ? "اختر نوع المنتج" : "Select product type"}
                </option>
            ...
            <div>
              ...
              >
                {isRTL
                  ? "تفاصيل المنتج (مواصفات – مستوى الجودة – الفئة السعرية) *"
                  : "Product details (specifications – quality level – price range) *"}
              </label>
              <textarea
                {...register("productDetails", {
                  ...
                  minLength: {
                    value: 10,
                    message: isRTL
                      ? "تفاصيل المنتج يجب أن تكون 10 أحرف على الأقل"
                      : "Product details must be at least 10 characters",
                  },
                })}
                rows={4}
                placeholder={
                  isRTL
                    ? "اذكر المواصفات المطلوبة ومستوى الجودة والفئة السعرية..."
                    : "Describe required specifications, quality level, and price range..."
                }
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                >
                  {isRTL
                    ...
                    : "Expected quantity or order size *"}
                </label>
                <input
                  type="text"
                  {...register("expectedQuantity", {
                    ...
                    minLength: {
                      value: 2,
                      message: isRTL
                        ? "الكمية يجب أن تكون حرفين على الأقل"
                        : "Quantity must be at least 2 characters",
                    },
                  })}
                  placeholder={
                    isRTL
                      ? "مثال: 1000 وحدة شهرياً"
                      : "Example: 1000 units monthly"
                  }
                  className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent ${
              ...
              <div>
                ...
                >
                  {isRTL
                    ? "البلد المفضل للتوريد أو التصدير *"
                    : "Preferred country for supply or export *"}
                </label>
                <input
                  type="text"
                  {...register("preferredCountry", {
                    ...
                    minLength: {
                      value: 2,
                      message: isRTL
                        ? "اسم البلد يجب أن يكون حرفين على الأقل"
                        : "Country name must be at least 2 characters",
                    },
                  })}
                  placeholder={
                    isRTL
                      ? "مثال: الصين، تركيا، ألمانيا..."
                      : "Example: China, Turkey, Germany..."
                  }
                  className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent ${
          ...
          <div className="space-y-6">
            ...
            <div>
              <div className="flex items-center mb-3">
                ...
                >
                  {isRTL
                    ? "هل لديك موردين أو مستوردين تتعامل معهم بالفعل؟"
                    : "Do you have existing suppliers or importers you work with?"}
                </label>
              </div>
              ...
              {watch("hasExistingPartners") && (
                <div>
                  ...
                  <textarea
                    ...
                    placeholder={
                      isRTL
                        ? "اذكر أسماء الشركات التي تتعامل معها حالياً..."
                        : "Mention the names of companies you currently work with..."
                    }
            ...
            <div>
              ...
              >
                ...
                <option value="world_class" className="text-gray-900 ">
                  {isRTL ? "عالمي" : "World Class"}
                </option>
              </select>
            </div>
          </div>
        ...
        return (
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center">
                ...
                <label className="text-sm " dir={isRTL ? "rtl" : "ltr"}>
                  {isRTL
                    ? "هل تحتاج زيارات مصانع أو تحقق ميداني؟"
                    : "Do you need factory visits or field verification?"}
                </label>
              </div>
              ...
              <div className="flex items-center">
                ...
                <label className="text-sm " dir={isRTL ? "rtl" : "ltr"}>
                  {isRTL
                    ? "هل تحتاج خدمات تفاوض أو ترجمة؟"
                    : "Do you need negotiation or translation services?"}
                </label>
              </div>
              ...
              <div className="flex items-center">
                ...
                <label className="text-sm " dir={isRTL ? "rtl" : "ltr"}>
                  {isRTL
                    ? "هل تحتاج إشراف على الإنتاج أو فحص جودة؟"
                    : "Do you need production supervision or quality inspection?"}
                </label>
              </div>
              ...
              <div className="flex items-center">
                ...
                <label className="text-sm " dir={isRTL ? "rtl" : "ltr"}>
                  {isRTL
                    ? "هل تحتاج عينات قبل التعاقد؟"
                    : "Do you need samples before contracting?"}
                </label>
              </div>
            </div>
            ...
            <div>
              ...
              >
                {isRTL
                  ? "متى ترغب ببدء التعاون"
                  : "When do you want to start cooperation"}
              </label>
              <select
              ...
              >
                ...
                <option value="one_month" className="text-gray-900">
                  {isRTL ? "خلال شهر" : "Within a month"}
                </option>
                <option value="three_months" className="text-gray-900">
                  {isRTL ? "خلال 3 شهور" : "Within 3 months"}
                </option>
              </select>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              >
                ...
                <option value="facebook" className="text-gray-900">
                  {isRTL ? "فيسبوك" : "Facebook"}
                </option>
                <option value="instagram" className="text-gray-900">
                  {isRTL ? "انستقرام" : "Instagram"}
                </option>
                <option value="twitter" className="text-gray-900">
                  {isRTL ? "تويتر" : "Twitter"}
                </option>
                <option value="friend" className="text-gray-900">
                  {isRTL ? "صديق" : "Friend"}
                </option>
            ...
            <div>
              ...
              <textarea
                ...
                placeholder={
                  isRTL
                    ? "أي معلومات إضافية أو طلبات خاصة تريد مشاركتها معنا..."
                    : "Any additional information or special requests you want to share with us..."
                }
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                dir={isRTL ? "rtl" : "ltr"}
              />
      ...
      <div className="max-w-4xl mx-auto px-4">
        <div className=" rounded-lg shadow-lg p-8">
          <div className="text-center mb-8">
            ...
            >
              {isRTL
                ? "طلب خدمة توفير الموردين/المستوردين"
                : "Suppliers/Importers Service Request"}
            </h1>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
            ...
            <div className="flex justify-between pt-6">
              <button
                ...
                onClick={prev}
                disabled={step === 1}
                className="px-6 py-2 border border-gray-300 rounded-lg cursor-pointer transition-all duration-500  hover:text-gray-900  hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed"
                dir={isRTL ? "rtl" : "ltr"}
              >
              ...
              {step < 5 ? (
                <button
                  type="button"
                  onClick={handleNext}
                  className="px-6 py-2 cursor-pointer transition-all duration-500  hover:text-purple-800  hover:bg-purple-50 border hover:border-purple-600 outline-none bg-purple-600 text-white rounded-lg "
                  dir={isRTL ? "rtl" : "ltr"}
                >
                  {isRTL ? "التالي" : "Next"}
                </button>
